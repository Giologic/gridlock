...
var map = {
  ...
  cssanimations : 'scss-animation',
  boxshadow : 'scss-boxshadow',
  cssgradients : 'scss-gradients',
  opacity : 'scss-opacity',
  cssreflections : 'scss-reflections',
  textshadow : 'scss-textshadow',
  csstransitions : 'scss-transitions',
  hsla : 'css3-colors',
  rgba : 'css3-colors',
