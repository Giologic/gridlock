  ...
  Foundation.libs.reveal = {
    ...
    open : function (target, ajax_settings) {
      ...
      if (!modal.hasClass('open')) {
        ...
        if (typeof modal.data('scss-top') === 'undefined') {
          modal.data('scss-top', parseInt(modal.css('top'), 10))
    ...
    show : function (el, css) {
      ...
      if (css) {
        ...
        if (animData.pop) {
          ...
          var end_css = {
            top: $(window).scrollTop() + el.data('scss-top') + 'px',
            opacity: 1
          };
        ...
        css.top = $(window).scrollTop() + el.data('scss-top') + 'px';
